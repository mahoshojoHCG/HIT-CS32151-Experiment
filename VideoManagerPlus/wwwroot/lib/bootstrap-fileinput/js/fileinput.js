...
(function(factory) {
    ...
    FileInput.prototype = {
                ...
                get: function(i, isDisabled) {
                    var ind = "init_" + i,
                        ...
                        parseTemplate = function(cat, dat, fn, ft, id, ftr, ind, fc, t) {
                            ...
                            return self._generatePreviewTemplate(cat,
                                dat,
                                fn,
                                ft,
                                id,
        ...
        _setZoomContent: function($frame, animate) {
            ...
            self._handler($modal.find(".btn-prev"),
                "click",
                function() {
                    self._zoomSlideShow("prev", previewId);
                });
            self._handler($modal.find(".btn-next"),
                "click",
                function() {
                    ...
                    function() {
                        ...
                        $frame.fadeOut("slow",
                            function() {
                                ...
                                $frame.remove();
                                if (id && hasError) {
                                    self.$errorContainer.find('li[data-thumb-id="' + id + '"]').fadeOut("fast",
                                        function() {
                                            $(this).remove();
                                            if (!self._errorsExist()) {
                                                self._resetErrors();
        ...
        _validateAllImages: function() {
            ...
            $.each(self.fileManager.loadedImages,
                function(id, config) {
                    if (!config.validated) {
                        fsize = config.siz;
            ...
            readFile = function(i) {
                ...
                if (!$h.isEmpty(fileTypes) && $h.isArray(fileTypes)) {
                    for (j = 0; j < fileTypes.length; j += 1) {
                        typ = fileTypes[j];
                        func = settings[typ];
                        fileCount += !func || (typeof func !== "function")
                            ? 0
                            : (func(file.type,
                                    $h.getFileName(file))
                                ? 1
